...
public class WndBlacksmith extends Window {
	...
	public WndBlacksmith(Blacksmith troll, final Hero hero ) {
		...
		btnItem1 = new ItemButton() {
			...
			protected void onClick() {
				btnPressed = btnItem1;
				GameScene.selectItem( hero, itemSelector, com.watabou.pixeldungeon.windows.WndBag.Mode.UPGRADEABLE, TXT_SELECT );
			}
		};
	...
	protected com.watabou.pixeldungeon.windows.WndBag.Listener itemSelector = new WndBag.Listener() {
		@Override
