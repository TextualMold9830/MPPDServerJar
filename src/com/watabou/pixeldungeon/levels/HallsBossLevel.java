...
public class HallsBossLevel extends Level {
	...
	protected boolean build() {
		...
		for (int i=0; i < 5; i++) {
			...
			Painter.fill( this, 2 + i * 4, top, 4, bottom - top + 1, com.watabou.pixeldungeon.levels.Terrain.EMPTY );
			...
			for (int j=0; j < 4; j++) {
				if (Random.Int( 2 ) == 0) {
					...
					map[i*4+j + y*WIDTH] = com.watabou.pixeldungeon.levels.Terrain.WALL_DECO;
				}
			}
		}
		...
		Painter.fill( this, ROOM_LEFT, ROOM_TOP,
			ROOM_RIGHT - ROOM_LEFT + 1, ROOM_BOTTOM - ROOM_TOP + 1, com.watabou.pixeldungeon.levels.Terrain.EMPTY );
	...
	private void doMagic( int cell ) {
		set( cell, com.watabou.pixeldungeon.levels.Terrain.EMPTY_SP );
