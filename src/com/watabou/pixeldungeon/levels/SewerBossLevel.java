...
public class SewerBossLevel extends RegularLevel {
	...
	protected boolean build() {
		...
		room = (com.watabou.pixeldungeon.levels.Room)roomExit.connected.keySet().toArray()[0];
		...
		ArrayList<com.watabou.pixeldungeon.levels.Room> candidates = new ArrayList<com.watabou.pixeldungeon.levels.Room>();
		for (com.watabou.pixeldungeon.levels.Room r : roomExit.neigbours) {
		...
		if (candidates.size() > 0) {
			com.watabou.pixeldungeon.levels.Room kingsRoom = Random.element( candidates );
	...
	protected boolean[] water() {
		return com.watabou.pixeldungeon.levels.Patch.generate( 0.5f, 5 );
	}
	...
	protected void decorate() {
		...
		for (int i=start; i < end; i++) {
			if (i != exit) {
				...
				map[i + WIDTH] = com.watabou.pixeldungeon.levels.Terrain.EMPTY;
			}
		}
	...
	public void seal() {
		if (entrance != 0) {
			...
			set( entrance, com.watabou.pixeldungeon.levels.Terrain.WATER_TILES );
	...
	public void unseal() {
		if (stairs != 0) {
			...
			set( entrance, com.watabou.pixeldungeon.levels.Terrain.ENTRANCE );
			GameScene.updateMap( entrance );
		}
	}
