...
public class Generator {
	...
	public static enum Category {
		...
		FOOD	( 0,	Food.class ),
		GOLD	( 50,	com.watabou.pixeldungeon.items.Gold.class ),
		MISC	( 5,	com.watabou.pixeldungeon.items.Item.class );

		public Class<?>[] classes;
		public float[] probs;

		public float prob;
		public Class<? extends com.watabou.pixeldungeon.items.Item> superClass;

		private Category( float prob, Class<? extends com.watabou.pixeldungeon.items.Item> superClass ) {
			this.prob = prob;
			this.superClass = superClass;
		}

		public static int order( com.watabou.pixeldungeon.items.Item item ) {
	...
	public static com.watabou.pixeldungeon.items.Item random() {
		return random( Random.chances( categoryProbs ) );
	}

	public static com.watabou.pixeldungeon.items.Item random(Category cat ) {
		try {
			...
			case WEAPON:
				return randomWeapon();
			default:
				return ((com.watabou.pixeldungeon.items.Item)cat.classes[Random.chances( cat.probs )].newInstance()).random();
			}
	...
	public static com.watabou.pixeldungeon.items.Item random(Class<? extends com.watabou.pixeldungeon.items.Item> cl ) {
		try {
